// TODO: get target time from API
// async function getTargetTime() {
//   const res = await fetch("https://techfest2023.himti.com/api/time");
//   const data = await res.json();
//   return data.time;
// }

// const unixTargetTime = await getTargetTime();
const unixTargetTime = 1682742136;
